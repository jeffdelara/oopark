...
class ParkingSlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking_slot" do
    assert_difference('ParkingSlot.count') do
      post parking_slots_url, params: { parking_slot: { lot_size_id: @parking_slot.lot_size_id, vacant: @parking_slot.vacant, x: @parking_slot.x, y: @parking_slot.y } }
    end
  ...
  test "should update parking_slot" do
    patch parking_slot_url(@parking_slot), params: { parking_slot: { lot_size_id: @parking_slot.lot_size_id, vacant: @parking_slot.vacant, x: @parking_slot.x, y: @parking_slot.y } }
